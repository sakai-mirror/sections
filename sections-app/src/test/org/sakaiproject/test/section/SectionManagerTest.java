...
public class SectionManagerTest extends SectionsTestBase{
    ...
    public void testSectionMembership() throws Exception {
    	...
    	CourseSection sec1 = secMgr.addSection(course.getUuid(), "A section", firstCategory, new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    	CourseSection sec2 = secMgr.addSection(course.getUuid(), "Another section", firstCategory, new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    	CourseSection sec3 = secMgr.addSection(course.getUuid(), "A different kind of section", secondCategory, new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    	CourseSection sec4 = secMgr.addSection(course.getUuid(), "Barely even a section", thirdCategory, new Integer(10), null, null, null, null, false, false, false,  false, false, false, false);
		...
		secMgr.updateSection(sec1.getUuid(), "New title", new Integer(10), null, null, null, null, false, false, false, false, false, false, false);
