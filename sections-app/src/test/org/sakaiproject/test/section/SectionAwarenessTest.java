...
public class SectionAwarenessTest extends SectionsTestBase{
    ...
    public void testSectionsAndCategories() throws Exception {
    	...
    	CourseSection sec = secMgr.addSection(course.getUuid(), "A section", firstCategory, new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    ...
    public void testSectionSorting() throws Exception {
    	...
    	CourseSection sec1 = secMgr.addSection(course.getUuid(), "aSection", firstCategory, new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    	CourseSection sec2 = secMgr.addSection(course.getUuid(), "bSection", firstCategory, new Integer(10), null, null, null, null, false, false, false,  false, false, false, false);

    	CourseSection sec3 = secMgr.addSection(course.getUuid(), "aaSection", secondCategory, new Integer(10), null, null, null, null, false, false, false,  false, false, false, false);
    	CourseSection sec4 = secMgr.addSection(course.getUuid(), "bbSection", secondCategory, new Integer(10), null, null, null, null, false, false, false,  false, false, false, false);
    	
    	CourseSection sec5 = secMgr.addSection(course.getUuid(), "aaaSection", null, new Integer(10), null, null, null, null, false,  false, false, false, false, false, false);
    	CourseSection sec6 = secMgr.addSection(course.getUuid(), "bbbSection", null, new Integer(10), null, null, null, null, false,  false, false, false, false, false, false);
