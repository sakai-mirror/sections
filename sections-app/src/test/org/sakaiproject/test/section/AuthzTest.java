...
public class AuthzTest extends SectionsTestBase{
    ...
    public void testSectionMembership() throws Exception {
    	...
    	CourseSection sec1 = secMgr.addSection(course.getUuid(), "A section", (String)categories.get(0), new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
    	CourseSection sec2 = secMgr.addSection(course.getUuid(), "Another section", (String)categories.get(1), new Integer(10), null, null, null, null, false,  false, false,  false, false, false, false);
