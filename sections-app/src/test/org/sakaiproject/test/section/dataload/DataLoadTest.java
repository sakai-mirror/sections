...
public class DataLoadTest extends SectionsTestBase {
	...
	public void testLoadData() {
		// Load courses
		Course course1 = courseManager.createCourse("site1", "A Course for Site #1", false, false);
		Course course2 = courseManager.createCourse("site2", "A Course for Site #2", false, false);
		Course course3 = courseManager.createCourse("site3", "A Course for Site #3", false, false);

		// Load sections
    	CourseSection lab1 = sectionManager.addSection(course1.getUuid(), "Lab 1", "section.category.lab", new Integer(20), "Dank basement lab", new Time(new Date().getTime()), new Time(new Date().getTime()), null, true, false, true,  false, false, false, false);
    	CourseSection lab2 = sectionManager.addSection(course1.getUuid(), "Lab 2", "section.category.lab", new Integer(20), "Dank basement lab", new Time(new Date().getTime()), new Time(new Date().getTime()), null, false, true, false, true, false, false, false);
    	CourseSection disc1 = sectionManager.addSection(course1.getUuid(), "Disc 1", "section.category.discussion", new Integer(30), "Sunny classroom", new Time(new Date().getTime()), new Time(new Date().getTime()), null, true, false, true,  false, true, false, false);
